...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Off by default: a normal send only asks Jev to select a model after the user enables it.
  jevAutoSelectModel: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  jevAutoSelectModel: Schema.optionalKey(Schema.Boolean),
