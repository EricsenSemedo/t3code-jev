...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
const APP_DISPLAY_NAME = isDevelopment ? "T3 Code Personal (Dev)" : "T3 Code Personal (Alpha)";
const APP_BUNDLE_ID = isDevelopment
  ? `com.ericsensemedo.t3codejev.dev.${devBundleIdSuffix || "local"}`
  : "com.ericsensemedo.t3codejev";
