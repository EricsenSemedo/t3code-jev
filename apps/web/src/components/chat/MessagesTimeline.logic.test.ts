...
describe("resolveAssistantMessagePlayState", () => {
  it("shows playback only for completed terminal messages when enabled", () => {
    expect(
      resolveAssistantMessagePlayState({
        showCopyButton: true,
        text: "Ready to play",
    ...
    ).toEqual({ text: "Ready to play", visible: true });
  });

  it("hides playback when disabled or while streaming", () => {
    expect(
      resolveAssistantMessagePlayState({
        showCopyButton: true,
        text: "Disabled",
