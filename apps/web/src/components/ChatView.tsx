...
export default function ChatView(props: ChatViewProps) {
  ...
  const suggestTaskRoute = useAtomCommand(serverEnvironment.suggestTaskRoute, {
    reportFailure: false,
    reportDefect: false,
  });
  const openTerminal = useAtomCommand(terminalEnvironment.open, "terminal open");
  ...
  const [isJevRouting, setIsJevRouting] = useState(false);
  ...
  const onSend = async (
    ...
    const threadCreateModelSelection = createModelSelection(
      ...
      dispatchModel || activeProjectDefaultModelSelection?.model || DEFAULT_MODEL,
    ...
    if (failure === null && isServerThread) {
      const settingsResult = await persistThreadSettingsForNextTurn({
        threadId: threadIdForSend,
        createdAt: messageCreatedAt,
        ...(dispatchModel ? { modelSelection: dispatchModelSelection } : {}),
        ...(localCheckoutBranchMismatch
          ? { branch: localCheckoutBranchMismatch.currentBranch }
          : {}),
        runtimeMode,
                      ...
                      <ComposerSurface.Host>
                        <div ref={attachDraftHeroComposerAnchorRef} className="relative z-10">
                          <ChatComposer
                            ...
                            jevAutoSelectModel={settings.jevAutoSelectModel}
                            onJevAutoSelectModelChange={(jevAutoSelectModel) => {
                              void updateClientSettings({ jevAutoSelectModel });
                            }}
                            ...
                            isSendBusy={isSendBusy || isJevRouting}
